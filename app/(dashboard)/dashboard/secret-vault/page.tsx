...
import SecretVaultTable from "./secret-vault-table";
import { CRUD } from "@/lib/types";

import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Secret Vault — Dashboard",
  description: "Manage encrypted API keys and integration secrets",
};

export default async function DashboardSecretVaultPage({
  searchParams,
}: {
  ...
  const where = getSecretFilterWhere(filterParams, false);
  ...
  const userIds = secrets.flatMap((s) => [s.created_by, s.updated_by]);
