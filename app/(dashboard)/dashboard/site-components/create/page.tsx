...
export const metadata: Metadata = {
  title: "Create Site Component",
  description: "Register a new dynamic storefront UI component",
};

export default async function CreateSiteComponentPage() {
  await assertPermission("create", "/dashboard/site-components");
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Register a new dynamic layout section available for storefront page composition.
          </p>
        </div>
        <div>
          <Link
