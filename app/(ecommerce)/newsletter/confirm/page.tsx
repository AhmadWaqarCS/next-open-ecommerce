        ...
        {result.success ? (
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="text-sm text-zinc-400 leading-relaxed max-w-sm">
              Thank you for subscribing{result.email ? <> as <strong className="text-zinc-200">{result.email}</strong></> : ""}. You will now receive our latest news, exclusive promotions, and updates directly in your inbox.
            </p>
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="text-xs text-zinc-500 max-w-xs">
              Please enter your email again in the newsletter form on our website to get a new confirmation link.
            </p>
